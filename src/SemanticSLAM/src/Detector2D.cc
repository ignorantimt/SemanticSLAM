...
namespace ORB_SLAM2 {
    ...
    dynamic_detection_confidence_threshold(dynamic_detection_confidence_threshold_)
    {
        ...
        detect_net_ptr->load_param("/home/tengfei/SemanticSLAM/src/SemanticSLAM/Thirdparty/ncnn_model/mobilenetv3_ssdlite_voc.param");
        detect_net_ptr->load_model("/home/tengfei/SemanticSLAM/src/SemanticSLAM/Thirdparty/ncnn_model/mobilenetv3_ssdlite_voc.bin");
