...
void Viewer::Run()
{
    ...
    pangolin::CreateWindowAndBind("SemanticSLAM: Map Viewer",1024,768);
    ...
    cv::namedWindow("SemanticSLAM: Current Frame");
    ...
    while(1)
    {
        ...
        //mpMapDrawer->DrawObject(); //draw Object in pangolin window
        ...
        cv::imshow("SemanticSLAM: Current Frame",image_to_show);
        cv::waitKey(mT);
